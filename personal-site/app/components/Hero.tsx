...
export default function Hero() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-primary-50">
      {/* Background Pattern */}
      ...
      <div className="container-max section-padding text-center relative z-10">
        <div className="animate-fade-in">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto mb-8 leading-relaxed">
            Architecting secure AI infrastructure that scales. Built DefendAI's core security platform processing <span className="font-semibold text-primary-600">10M+ daily LLM requests</span> for Fortune 500 companies. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto mb-12">
            <div className="text-center">
              ...
              <div className="text-gray-600">Daily LLM Requests</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-gray-600">Security Incidents Reduced</div>
            </div>
          </div>
